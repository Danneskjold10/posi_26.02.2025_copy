<!-- src/lib/components/SimpleEditableItem.svelte -->
<script>
    import { incrementQuantity, decrementQuantity } from '../directDomUpdates.js';
  ...
  <div class="flex items-center py-4 border-b border-gray-200 last:border-b-0">
    ...
    <div class="flex flex-col items-center ml-4">
      <div class="flex items-center space-x-2 border border-gray-300 rounded-lg overflow-hidden">
        ...
        <span id="item-quantity-{index}" class="px-2 font-medium">{item.quantity}</span>
      ...
      <!-- Add an ID for direct DOM manipulation -->
      <div id="item-subtotal-{index}" class="text-sm font-bold mt-2">
